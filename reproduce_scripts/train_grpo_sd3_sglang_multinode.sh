#!/bin/bash
# =============================================================================
# FlowGRPO SD3 multi-node — SGLang separate mode
# =============================================================================
#
...
#   bash reproduce_scripts/train_grpo_sd3_sglang_multinode.sh
#   bash reproduce_scripts/train_grpo_sd3_sglang_multinode.sh auto
#
#   # Manual mode:
#   HEAD_IP=10.0.0.1 NODE_IP=10.0.0.1 bash reproduce_scripts/train_grpo_sd3_sglang_multinode.sh head
#   HEAD_IP=10.0.0.1 NODE_IP=10.0.0.2 bash reproduce_scripts/train_grpo_sd3_sglang_multinode.sh worker
#   HEAD_IP=10.0.0.1 bash reproduce_scripts/train_grpo_sd3_sglang_multinode.sh train
#
...
#   learning_rate=3e-4, LoRA rank=32 alpha=64, timestep_fraction=0.99
#
# =============================================================================
...
WEIGHT_SYNC_DIR="${WEIGHT_SYNC_DIR:-/mnt/shared/diffusionrl_weight_sync/grpo_sd3_sglang_multinode}"
...
WANDB_RUN_NAME="${WANDB_RUN_NAME:-SD3.5-Flow-GRPO-SGLang-multinode}"
WANDB_LOG_MEDIA=true
WANDB_MEDIA_MAX_ITEMS=48
WANDB_TAGS="${WANDB_TAGS:-reproduce,sd3.5,flow,sglang,${REWARD_NAME},multinode}"
