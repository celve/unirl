...
NFT_ALGO_KWARGS=${NFT_ALGO_KWARGS:-'{"beta":1,"adv_mode":"raw","adv_clip_max":5.0,"use_adaptive_weight":true,"ema_decay":0.001}'}
NFT_LOSS_KWARGS=${NFT_LOSS_KWARGS:-'{"beta":1,"adv_mode":"raw","adv_clip_max":5.0,"use_adaptive_weight":true,"nft_timestep_mode":"all","nft_shuffle_timesteps":true,"nft_apply_shift":false,"use_ema":true,"ema_decay":0.001,"decay_type":"warmup","ema_flat_steps":0,"ema_uprate":0.001,"ema_uphold":0.5,"shuffle_seed":42,"shuffle_samples":true}'}
