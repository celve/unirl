...
| [`deep_research/`](deep_research/) | `python -m unirl.train_sao_deep_research` | `deep_research/deep_research_sao_4b_smoke` | `qwen3` actor + independent token-value critic |
