...
pure implementation divergence. Sequence:
  ...
  1. Boot the vllm_omni_v2 engine (qwen_image_t2i); generate ONE sample with
...
Usage (pod, venv active, ONE free GPU):
  ...
  python examples/vllm_omni_v2_parity_probe.py
"""
...
def main() -> int:
    ...
    cfg = VLLMOmniV2EngineConfig(model_path=model_path, modality="qwen_image_t2i", enable_sleep_mode=False)
