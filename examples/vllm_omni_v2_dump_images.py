#!/usr/bin/env python
"""Dump sample images from a vllm_omni_v2 engine (LIN-382 visual check).
...
Usage (inside the pod, venv active, GPUs free):
  ...
  python examples/vllm_omni_v2_dump_images.py
"""
...
def main() -> int:
    ...
    cfg = VLLMOmniV2EngineConfig(model_path=model_path, modality=modality, enable_sleep_mode=False)
