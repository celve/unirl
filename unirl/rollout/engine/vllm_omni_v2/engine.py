"""``vllm_omni_v2`` engine core — wiring + delegation only.
...
from unirl.rollout.engine.vllm_omni_v2.backends import VLLMOmniBackend
...
class VLLMOmniV2RolloutEngine(BaseRolloutEngine):
    """Rollout engine backed by vllm-omni's ``Omni`` orchestrator (v2 layout)."""

    _component_name = "vllm_omni_v2"

    def __init__(
        self,
        config: VLLMOmniV2EngineConfig,
        *,
    ...
    def generate(self, req: RolloutReq) -> RolloutResp:
        ...
        require(
            ...
            "VLLMOmniV2RolloutEngine.generate: engine is offloaded (wake_up first).",
        )
...
__all__ = ["VLLMOmniV2RolloutEngine"]
