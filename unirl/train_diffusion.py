...
Pairs with ``recipes/diffusion_rl/sd3_trainside.yaml`` (default) and
``recipes/diffusion_rl/sd3_vllmomni.yaml``. Switch with
``--config-name diffusion_rl/sd3_vllmomni`` on the CLI.
"""
