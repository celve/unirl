...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/flowgrpo_fast_qwen_image_4x8}"
QWEN_IMAGE_PATH="${QWEN_IMAGE_PATH:-Qwen/Qwen-Image}"
WANDB_RUN_NAME="${WANDB_RUN_NAME:-Qwen-Image-FlowGRPO-4x8}"
...
CMD=(
    ...
    "training.plan.local_mini_batch_size=${LOCAL_MINI_BATCH_SIZE:-9}"
    "training.plan.local_batch_size=${LOCAL_BATCH_SIZE:-18}"
    "training.topology.actor_count=${ACTOR_COUNT:-32}"
