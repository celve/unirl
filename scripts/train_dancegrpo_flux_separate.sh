#!/bin/bash
# =============================================================================
# DanceGRPO training with FLUX model (Separate mode - inference/training on different GPUs)
# =============================================================================
#
# REPRODUCE TARGET:
...
#
# This script runs DanceGRPO with FLUX in separate mode where inference and
...
# Memory-optimized settings for 4 (inference) + 4 (training) GPUs
