#!/bin/bash
# =============================================================================
# MixGRPO training with FLUX model (Separate mode - inference/training on different GPUs)
# =============================================================================
#
# REPRODUCE TARGET:
...
#
# This script runs MixGRPO with FLUX in separate mode. MixGRPO uses:
...
OUTPUT_DIR=${OUTPUT_DIR:-"${REPO_ROOT}/outputs/mixgrpo_flux_separate"}
