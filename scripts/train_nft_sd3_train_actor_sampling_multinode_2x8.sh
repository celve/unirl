#!/bin/bash
# =============================================================================
# DiffusionNFT SD3 multi-node helper (2 nodes x 8 GPUs by default)
# =============================================================================
#
...
#
# It reuses:
#   scripts/train_nft_sd3_train_actor_sampling.sh
#
# Usage examples:
#   # Node 0 (head)
#   HEAD_IP=10.0.0.1 NODE_IP=10.0.0.1 bash scripts/train_nft_sd3_train_actor_sampling_multinode_2x8.sh head
#
#   # Node 1 (worker)
#   HEAD_IP=10.0.0.1 NODE_IP=10.0.0.2 bash scripts/train_nft_sd3_train_actor_sampling_multinode_2x8.sh worker
#
...
#   HEAD_IP=10.0.0.1 WEIGHT_SYNC_DIR=/mnt/shared/diffusionrl_weight_sync \
#     bash scripts/train_nft_sd3_train_actor_sampling_multinode_2x8.sh train \
#       --rollout.num-rollout 100 --training.gradient-accumulation-batch-size 2
#
# =============================================================================
...
BASE_TRAIN_SCRIPT="${SCRIPT_DIR}/train_nft_sd3_train_actor_sampling.sh"
...
WEIGHT_SYNC_DIR="${WEIGHT_SYNC_DIR:-/mnt/shared/diffusionrl_weight_sync}"
...
case "${ROLE}" in
    ...
    train)
        ...
        TRAINING_NUM_NODES="${NUM_NODES}" \
        TRAINING_GPUS_PER_NODE="${GPUS_PER_NODE}" \
