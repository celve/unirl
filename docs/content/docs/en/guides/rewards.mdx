...
The current YAML shape, component contract, and scorer extension workflow live in the generated [Reward Package README](/en/docs/guides/readme-reference/unirl-reward).
