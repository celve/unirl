...
Model implementation packages live under `unirl/models/`. Use the generated [Model Package README](/en/docs/guides/readme-reference/unirl-models) for package layout and extension contracts.
