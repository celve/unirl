...
`unirl/README.md` and package READMEs under **Architecture → README Reference** in the sidebar.
...
- [Code Architecture README](/en/docs/architecture/readme-reference/unirl) for the module map and runtime data flow.
- [Rollout Package README](/en/docs/architecture/readme-reference/unirl-rollout) for rollout modes and request/response contracts.
- [Train Stack README](/en/docs/architecture/readme-reference/unirl-train) for the FSDP backend, the train-step contract, and structural injection.
- [Algorithms Package README](/en/docs/architecture/readme-reference/unirl-algorithms) for per-track loss contracts and the reward→advantage path.
- [SDE Package README](/en/docs/architecture/readme-reference/unirl-sde) for SDE strategy rules, schedules, and runtime kernels.
- [Weight Sync README](/en/docs/architecture/readme-reference/unirl-weight-sync) for dedicated rollout synchronization.
...
[Rollout Package README](/en/docs/architecture/readme-reference/unirl-rollout) as the
source of truth.
