...
如果文档其余部分出现你不熟悉的术语，请先读本页。它是概念入门，不是 API 参考；贴近代码的契约见
...
| Train stack | `TrainStack`——单 stage 的 loss/backward 驱动；多 track 用兄弟 stack；HI3 用 `hi3_stack`。 |
...
- 算法 loss 数学与 reward→advantage 路径：[Algorithms Package README](/en/docs/architecture/readme-reference/unirl-algorithms)。
