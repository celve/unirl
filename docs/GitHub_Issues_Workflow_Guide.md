# GitHub Issues Workflow Guide / GitHub Issues 工作流指南
...
## References / 参考资料
- Related code path: `diffusionrl/xxx/yyy.py`
- Related paper / link
...
```markdown
Title: [Tracking] DiffusionRL Training Pipeline Optimization
标题：[Tracking] DiffusionRL 训练流程优化
