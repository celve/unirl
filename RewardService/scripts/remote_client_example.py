...
— copy it anywhere, as long as ``reward-service`` is on the Python path it
will run.

Usage:
    # from anywhere after `pip install /path/to/RewardService`
...
``python3 -m pip show reward-service`` to check, or install with
``python3 -m pip install /path/to/RewardService`` (the ``python3 -m pip``
