...
14. Add at least one experiment YAML under `conf/experiment/` and document external checkpoint requirements there or in launcher environment docs.
...
- Experiment YAML exists under `conf/experiment/` and documents required checkpoints or environment variables.
