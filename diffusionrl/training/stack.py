...
:class:`Policy` Protocol (``training/policy.py``). FSDP wrap, LoRA
...
from diffusionrl.training.policy import Policy, walk_source_chain
...
class StageTrainStack:
    ...
    def on_rollout_end(self) -> None:
        ...
        Called by ``train_actor._train_resp`` after a rollout's
