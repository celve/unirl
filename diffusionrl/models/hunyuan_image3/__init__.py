...
protocols. Mirrors :mod:`diffusionrl.models.sd3` 1:1 in layout.
...
``diffusionrl.models.hunyuan_image3`` is enough to make
``model/hunyuan_image3`` resolvable in the ConfigStore.
"""

from diffusionrl.models.hunyuan_image3.ar import (
    HunyuanImage3ARParams,
    HunyuanImage3ARStage,
    HunyuanImage3ARStep,
)
from diffusionrl.models.hunyuan_image3.bundle import HunyuanImage3Bundle
...
from diffusionrl.models.hunyuan_image3.pipeline import HunyuanImage3Pipeline
from diffusionrl.models.hunyuan_image3.text_embed import (
    HunyuanImage3TextEmbedStage,
)
from diffusionrl.models.hunyuan_image3.vae import (
    HunyuanImage3VAEDecodeStage,
    HunyuanImage3VAEEncodeStage,
)
from diffusionrl.models.hunyuan_image3.vit_encode import (
