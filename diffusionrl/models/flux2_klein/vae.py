...
``main_flux_bundle/diffusionrl/models/flux2.py::decode_latents`` and
the sampling-side BN denormalize in
``main_flux_bundle/diffusionrl/samplers/fsdp/flux2_sampler.py``. The
...
from diffusionrl.models.types.codec import DecodeStage
