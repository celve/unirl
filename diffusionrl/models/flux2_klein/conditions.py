...
Mirrors :class:`diffusionrl.models.sd3.SD3Conditions` and
:class:`diffusionrl.models.qwen_image.QwenImageConditions`: text +
...
``RolloutResp.conditions`` sees ``"text"`` and ``"negative_text"`` as
