...
Sibling of :class:`diffusionrl.models.sd3.SD3PipelineConfig` and
:class:`diffusionrl.models.qwen_image.QwenImagePipelineConfig`.
...
:meth:`diffusionrl.sde.runtime.FlowMatchSchedulePolicy.compute_sigma` does the rest. The
...
@register_config(
    group="model",
    name="flux2_klein_v2",
    target="diffusionrl.models.flux2_klein.Flux2KleinPipeline.from_config",
    mutable=True,
)
@dataclass
class Flux2KleinPipelineConfig:
    ...
    # ``main_flux_bundle/diffusionrl/models/flux2.py`` Klein detection.
