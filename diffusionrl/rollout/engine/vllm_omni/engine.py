...
from diffusionrl.rollout.engine.vllm_omni.response import (
    _to_rollout_resp,
    group_by_request,
)
...
class VLLMOmniRolloutEngine(BaseRolloutEngine):
    ...
    def generate(self, req: RolloutReq) -> RolloutResp:
        ...
        if self.cfg.modality != "sd35_t2i" and self._tokenizer is None:
    ...
    def _validate_request(self, req: RolloutReq) -> None:
        ...
        m = self.cfg.modality
        if m in ("t2i", "sd35_t2i", "t2i_think_recaption") and has_image:
            raise ValueError(
