...
from diffusionrl.rollout.engine.vllm_omni.compat.tokenizer import HI3ARWorkerExtension
from diffusionrl.rollout.engine.vllm_omni.weight_sync.ipc_receive_mixin import (
    BucketedIPCReceiveMixin,
)
from diffusionrl.rollout.engine.vllm_omni.weight_sync.nccl_receive_mixin import (
