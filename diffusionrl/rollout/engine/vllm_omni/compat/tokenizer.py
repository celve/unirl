...
def install() -> None:
    ...
    Idempotent via the ``_diffusionrl_none_filter`` sentinel attribute
    ...
    for cls in candidates:
        ...
        if method is None:
            continue
        if getattr(method, "_diffusionrl_none_filter", False):
        ...
        _filtered._diffusionrl_none_filter = True  # type: ignore[attr-defined]
...
from diffusionrl.rollout.engine.vllm_omni.compat import hi3_lora as _hi3_lora_compat  # noqa: F401, E402
