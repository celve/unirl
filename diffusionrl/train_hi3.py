#!/usr/bin/env python
"""diffusionRL v2 HunyuanImage3 training entry point (Hydra-native).

Thin wrapper around :class:`diffusionrl.trainer.hi3.HI3Trainer`. The trainer
...
Pairs with ``conf/hi3_vllmomni.yaml``::

    python -m diffusionrl.train_hi3 --config-name hi3_vllmomni
"""
...
from diffusionrl.trainer.hi3 import HI3Trainer


@hydra.main(version_base=None, config_path="../conf", config_name="hi3_vllmomni")
