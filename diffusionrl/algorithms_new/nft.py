...
:class:`diffusionrl.training_new.nft_lora_policy.NFTLoRAPolicy`. The
...
@register_config(
    group="training_new/algorithm",
    name="diffusion_nft",
    target="diffusionrl.algorithms_new.nft.DiffusionNFT",
    mutable=True,
)
@dataclass
...
class DiffusionNFT(StageAlgorithm):
    ...
    Args:
        ...
        nft_lora_policy: The :class:`NFTLoRAPolicy` instance owning the
            ...
            ``new_train_actor`` at algorithm-construction time (the
        ...
        *,
        ...
        if segment.latents is None:
            raise ValueError(
                ...
                "(rollout/new_pipeline.py:725-746)."
            )
