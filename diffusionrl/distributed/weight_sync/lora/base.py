...
- :class:`~diffusionrl.distributed.weight_sync.lora.local.LocalLoraWeightSync` —
  same-Worker sibling, in-process push.
- :class:`~diffusionrl.distributed.weight_sync.lora.remote.RemoteLoraWeightSync`
...
class LoraWeightSyncBase(Remote):
    ...
    a :class:`~diffusionrl.rollout.engine.composed.engine.ComposedRolloutEngine`
