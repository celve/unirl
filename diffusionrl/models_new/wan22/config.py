...
@register_config(
    group="model",
    name="wan22_v2",
    target="diffusionrl.models_new.wan22.WAN22Pipeline.from_config",
    mutable=True,
)
@dataclass
class WAN22PipelineConfig(WAN21PipelineConfig):
    ...
    # Used by training-time helpers / scheduler initialization. Matches
    # legacy ``WAN22ModelBundleConfig.num_train_timesteps`` default.
