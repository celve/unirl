...
class QwenImagePipeline(Pipeline):
    ...
    def from_config(
        ...
        *,
        ...
        :class:`FlowSDEStrategy` (legacy Qwen-Image default in
        ``samplers/fsdp/qwen_image_sampler.py:51``); callers running
        GRPO with a different SDE family (Dance / CPS / DPM2) pass an
    ...
    def generate(self, req: RolloutReq) -> RolloutResp:
        ...
        if req.sigmas is None:
            raise ValueError(
                ...
                "diffusionrl.models_new.types.pipeline."
            )
        ...
        # (e.g. NewRolloutPipeline) stash rollout-metadata keys here
