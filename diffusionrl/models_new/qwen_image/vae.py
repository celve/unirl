...
Per-channel normalization math copied from ``models/qwen_image.py
::decode_latents`` (PR #104) — the new-design path does NOT import
legacy code; spec sync is via review / test.
"""
