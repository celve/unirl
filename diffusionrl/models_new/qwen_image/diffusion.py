...
Three classes mirror :mod:`diffusionrl.models_new.sd3.diffusion`:
...
Math mirrors ``samplers/fsdp/qwen_image_sampler.py`` (PR #104) and
``models/qwen_image.py::forward_denoiser`` (PR #104). The new-design
path does NOT import legacy code; spec sync is via review / test.
"""
