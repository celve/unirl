...
Diverges from :class:`diffusionrl.models_new.wan21.WAN21Bundle` mainly
in the dual text-encoder pair + the optional SigLIP path. Diverges from
:class:`diffusionrl.models_new.hunyuan_image3.HunyuanImage3Bundle` in
...
threaded through the training forward, which the new-design pipeline
