...
Sibling of :class:`diffusionrl.models_new.wan21.WAN21PipelineConfig`.
...
@register_config(
    group="model",
    name="hunyuan_video15_v2",
    target="diffusionrl.models_new.hunyuan_video15.HunyuanVideo15Pipeline.from_config",
    mutable=True,
)
@dataclass
