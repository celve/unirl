...
Sibling of :mod:`diffusionrl.models_new.wan21` (text-to-video peer)
and :mod:`diffusionrl.models_new.hunyuan_image3` (Hunyuan-family peer).

The OLD ``hunyuan_veido1p5`` typo is dropped here — the NEW package is
...
``diffusionrl.models_new.hunyuan_video15`` is enough to make
``model/hunyuan_video15_v2`` resolvable in the ConfigStore.
...
from diffusionrl.models_new.hunyuan_video15.config import HunyuanVideo15PipelineConfig
from diffusionrl.models_new.hunyuan_video15.diffusion import HunyuanVideo15DiffusionParams
from diffusionrl.models_new.hunyuan_video15.pipeline import HunyuanVideo15Pipeline
