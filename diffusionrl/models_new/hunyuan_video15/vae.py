...
Diverges from :class:`diffusionrl.models_new.wan21.WAN21VAEDecodeStage`
...
(PR #101). The new-design path does NOT import legacy code.
"""
...
from diffusionrl.models_new.types.codec import DecodeStage
from diffusionrl.types.primitives import Video, Videos
