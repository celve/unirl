...
Mirrors :class:`diffusionrl.models_new.sd3.config.SD3PipelineConfig` minus
...
@register_config(
    group="model",
    name="hunyuan_image3_v2",
    target="diffusionrl.models_new.hunyuan_image3.HunyuanImage3Pipeline.from_config",
    mutable=True,
)
@dataclass
