...
the smoke / training stack constructs the bundle manually with
``device_map="auto"``, see ``scripts/smoke_hunyuan_image3.py``.
...
class HunyuanImage3Bundle:
    ...
    def from_config(cls, config: HunyuanImage3PipelineConfig) -> "HunyuanImage3Bundle":
        ...
        bundle directly via ``__init__`` (see
        ``scripts/smoke_hunyuan_image3.py``).
        """
    ...
    def build_t2i_inputs(
        ...
        *,
        ...
        KV cache is intentionally NOT built — the diffusionrl per-step
