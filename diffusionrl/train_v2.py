#!/usr/bin/env python
"""diffusionRL v2 training entry point (Hydra-native).
...
Pairs with ``conf_v2/sd3_trainside.yaml`` (default) and
``conf_v2/sd3_vllmomni.yaml``. Switch with
...
@hydra.main(version_base=None, config_path="../conf_v2", config_name="sd3_trainside")
