"""diffusionRL v2 HunyuanImage3 unified-backbone trainer.
...
Two-engine design (mirrors :class:`~diffusionrl.models.pe.pipeline.PEPipeline`'s
...
:class:`~diffusionrl.trainer.pe.PETrainer`: score the image track, credit-assign
...
Pairs with ``conf/hi3_vllmomni.yaml`` and ``diffusionrl/train_hi3.py``.
...
from diffusionrl.distributed.group.placement import placement
from diffusionrl.distributed.tensor.transport import TensorMeta, _collect_leaves
...
from diffusionrl.types.rollout_resp import RolloutResp, _hydrate_tensor_meta, _track_with_field
from diffusionrl.types.sampling import BaseSamplingParams, get_ar_params, get_diffusion_params
