...
@dataclass
class TQBatchMetaBatched(Batched):
    ...
    @classmethod
    def concat(cls: "TQBatchMetaBatched", items: Sequence["TQBatchMetaBatched"]):
        if not items:
    ...
    def slice(self: "TQBatchMetaBatched", start: int, end: int):
        bs = self.batch_size
        kwargs: Dict[str, Any] = {}
