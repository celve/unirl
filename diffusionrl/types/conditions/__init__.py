...
from diffusionrl.types.conditions.fused_multimodal import FusedMultimodalCondition
from diffusionrl.types.conditions.image import ImageEmbedCondition, ImageLatentCondition
from diffusionrl.types.conditions.text import TextEmbedCondition, TextTokenCondition
