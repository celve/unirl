...
Mirrors :class:`diffusionrl.train.stack.TrainStack` but for the unified-backbone
...
This is the new-scheduling equivalent of the legacy
``diffusionrl.training.stack.StageTrainStack`` "many algorithms, one optimizer
step" semantic.
"""
...
from diffusionrl.train.stack import TrainStepResult, _build_micro_batch_slices
