...
def load_function(path: str) -> Any:
    ...
    Args:
        path: Full path to the class/function, e.g., "diffusionrl.algorithms.diffusion_grpo.DiffusionGRPO"

    Returns:
        The loaded class or function

    Example:
        >>> algo_cls = load_function("diffusionrl.algorithms.diffusion_grpo.DiffusionGRPO")
    """
