...
The new-design path does not use a Backend protocol; both factories accept a
``backend=None`` keyword for signature symmetry with the legacy
:mod:`diffusionrl.training.factories`.
"""
...
from diffusionrl.training_new.backends.base import LrSchedulerConfig, OptimizerConfig
