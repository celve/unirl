...
class ActorSamplingExecutor:
    ...
    def generate(
        ...
        **kwargs,
        ...
        guidance_scale = guidance_scale or actor._sampling_config.get("guidance_scale", 7.5)
    ...
    def generate_batch(self, actor: Any, requests: List[InferenceRequest]) -> List[SamplerOutput]:
        outputs = []
    ...
    def sample_batch(
        ...
        **kwargs,
        ...
        return self.generate(actor, prompts=prompts, **kwargs)
