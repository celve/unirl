...
This module belongs to the rollout workflow layer: it expands prompt batches
into typed rollout requests, handles request-level sub-batching, and aggregates
sampling results back into one rollout-shaped payload.
"""
...
class RolloutRequestBuilder:
    ...
    def execute_request_batches(
        ...
        *,
        ...
        execute_sampling_request: Callable[[RolloutRequest], SampledRequestResult],
        ...
        for batch_idx, current_request in tqdm(
            ...
            sampled_request = execute_sampling_request(request=current_request)
