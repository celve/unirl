...
Ctor / generate / weight-sync RPC plumbing requires a live SGLang scheduler
client and SGLang server subprocess and is not covered here.
"""
...
def test_class_has_all_weight_sync_methods():
    """Every transport on BaseRolloutEngine has a concrete or NotImplemented override."""
