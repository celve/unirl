...
from unirl.rollout.engine.vllm_omni.backends.native import _assemble_omni_kwargs
...
def test_assemble_omni_kwargs_omits_disabled_keys():
    ...
    injection semantics."""
    cfg = VLLMOmniEngineConfig(model_path="/x", modality="sd3_t2i", enable_sleep_mode=False)
...
mods = [
    ...
    "unirl.rollout.engine.vllm_omni.config",
    "unirl.rollout.engine.vllm_omni.engine",
    "unirl.rollout.engine.vllm_omni.weight_sync",
    "unirl.rollout.engine.vllm_omni.backends",
    "unirl.rollout.engine.vllm_omni.backends.base",
    "unirl.rollout.engine.vllm_omni.backends.native",
    "unirl.rollout.engine.vllm_omni.adapters",
    "unirl.rollout.engine.vllm_omni.utils",
    "unirl.rollout.engine.vllm_omni.patches",
    "unirl.rollout.engine.vllm_omni.worker",
    "unirl.rollout.engine.vllm_omni.pipelines",
]
for m in mods:
