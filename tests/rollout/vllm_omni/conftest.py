"""Shared fakes for the vllm_omni CPU tests.
...
def make_config(modality: str, **overrides: Any) -> VLLMOmniEngineConfig:
    return VLLMOmniEngineConfig(model_path="/ckpt", modality=modality, **overrides)
