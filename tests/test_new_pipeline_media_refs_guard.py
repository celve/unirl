"""Unit tests for the NEW driver's media_refs filter.

After Phase 4 the NEW driver consumes ``(modality="image",
...
from diffusionrl.rollout.new_pipeline import _reject_unsupported_media_refs
...
def test_unsupported_modality_raises_not_implemented() -> None:
    """Any non-image modality is unsupported on the NEW path."""
    refs = [
